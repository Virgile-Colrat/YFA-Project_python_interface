...
filename="results-054-spike_test-LED_2.30_GCMS_test1"                                          #names the file in which the results are stored 
...
##                   end experiment                    ##
#########################################################  
def openMFC(flowValue,time):
    flow_controller_A.set_flow_rate(flowValue)
    time.sleep(time)
    flow_controller_A.set_flow_rate(0)
