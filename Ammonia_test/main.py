...
#
#This python scripts execute the ammonia experiment using:
...
polarisationVoltage=-4.096                                  #polarization voltage of the sensors
numberMeasures=100

MFC1=FlowController(port='COM16', address='A')
MFC2=FlowController(port='COM16', address='B')
MFC3=FlowController(port='COM16', address='C')
Power_supply= rm.open_resource("GPIB::16::INSTR")
Omeagaette=Omeagaette_Control.OpenOmegaette()
#keithley=0
#omegaette=0
#flow_controller=0
#########################################################
